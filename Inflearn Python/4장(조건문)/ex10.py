...
# 사용자에게 구입 금액을 입력 받고 최종적으로 할인 금액과 지불 금액을 출력하는 프로그램 만들기
...
if total_price >= 50000:
    ...
    print("할인 금액 : ", round(discount), "원")
    print("최종 지불 금액 : ", round(sales_price), "원")
else:
    print("할인 금액 대상이 되질 않습니다.", total_price, "원을 결제해주세요.")